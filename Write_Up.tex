...
(\protect\hyperlink{ref-bad}{Kadkhoda}
(\protect\hyperlink{ref-bad}{2021}) p.471). According to the
\protect\hyperlink{ref-who}{World Health Organisation}
(\protect\hyperlink{ref-who}{2021}), COVID-19 has directly resulted in
4,859,277 deaths worldwide\footnote{As of 13 October 2021}, and the
impact on the global economy has been severe
(\protect\hyperlink{ref-bank}{World Bank}
(\protect\hyperlink{ref-bank}{2020})). Policymakers are in urgent need
of evidence-based strategies to contain the pandemic. One critical
mechanism through which epidemics are controlled is through herd
immunity (\protect\hyperlink{ref-immun}{Fontanet \& Cauchemez}
(\protect\hyperlink{ref-immun}{2020})). Herd immunity is where a certain
amount of the population is immune to a disease and can be achieved
through a certain threshold of the population being vaccinated.

The South African government has stated that it aims to have 67\% of the
population vaccinated by the end of 2021
(\protect\hyperlink{ref-herd}{RSA}
...
behavioural economics and vaccine lotteries. Section \ref{cont}
...
\hypertarget{the-south-african-context-context}{%
\section{The South African Context
\{context\}}\label{the-south-african-context-context}}
...
we? \emph{Nature reviews. Immunology}. 20.
